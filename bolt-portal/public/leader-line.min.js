...
var LeaderLine = (function() {
  ...
  function Fe(u) {
    ...
    if (
            ...
            g.socketSE[e] ||
              (f[e].width || f[e].height
                ...
                : ((t = b[e ? 0 : 1].x - f[e].left),
                  (n = b[e ? 0 : 1].y - f[e].top),
                  (b[e].socketId =
                    Math.abs(t) >= Math.abs(n) ? (0 <= t ? I : L) : 0 <= n ? C : M)))
          })),
      ...
      switch (
        ((u.pathList.baseVal = v = []), (u.pathList.animVal = null), E.position_path)
      ) {
        case A:
          v.push([O(b[0]), O(b[1])])
          break
  ...
  function De(e, t) {
    ...
    t.line &&
      ...
      (t.plug || ee.line) &&
        ...
        (f =
          We(h, c, 'plug_enabled', c.plug_enabledSE[0] || c.plug_enabledSE[1]) ||
          f))),
              ...
              (v =
                We(
                  ...
                  _.plugOutline_colorTraSE[e]
                    ? t -
                        (he / (_.line_strokeWidth / pe.lineSize) / g.plugSizeSE[e]) *
                          2
                    : t / 2
                ) || v))
        }),
      ...
      (t.faces || ee.line || ee.plug || ee.lineOutline || ee.plugOutline) &&
        ...
        We(
          ...
          (O = !0),
          (re || le) &&
            (Ae(E, E.lineShape), le && (Ae(E, E.lineFace), Ae(E, E.lineMaskCaps)))),
        We(
          E,
          k,
          'lineOutline_enabled',
  ...
  function Ze(s, u) {
    ...
    i &&
      ...
      (!(function(a, e) {
        ...
        ;(a.pathList = {}),
          ...
          (a.plugOutlineFaceSE = [0, 1].map(function(e) {
            ...
            return (
              (t.style.mask = 'url(#' + p[e] + ')'), (t.style.display = 'none'), t
            )
          })),
      ...
      (p.line =
        d(h, u, 'color', null, 'lineColor', null, pe.lineColor, null, !0) || p.line),
      (p.line =
      ...
      ['startPlug', 'endPlug'].forEach(function(e, t) {
        ;(p.plug = c(h, u, e, E, 'plugSE', t, pe.plugSE[t]) || p.plug),
          (p.plug =
            ...
            p.plug),
          (p.plug =
            d(h, u, e + 'Size', null, 'plugSizeSE', t, pe.plugSizeSE[t], function(
              e
            ) {
              return 0 < e
            }) || p.plug)
      ...
      ['startPlugOutline', 'endPlugOutline'].forEach(function(e, t) {
        ;(p.plugOutline =
          d(h, u, e, null, 'plugOutlineEnabledSE', t, pe.plugOutlineEnabledSE[t]) ||
          p.plugOutline),
          (p.plugOutline =
            d(
              h,
      ...
      ['startLabel', 'endLabel', 'middleLabel'].forEach(function(e, t) {
        ...
        if (
          ...
          if (
            (h.labelSEM[t] && (Ue(s, $[h.labelSEM[t]._id]), (h.labelSEM[t] = '')), o)
          ) {
            if (
              (r
  ...
  return (
            ...
            p
              ...
              : ((o.elmBlur = a.appendChild(e.createElementNS(b, 'feGaussianBlur'))),
                ...
                (i.appendChild(e.createElementNS(b, 'feMergeNode')).in1.baseVal =
                  'SourceGraphic')),
            o)
          ;['elmFilter', 'elmOffset', 'elmBlur', 'styleFlood', 'elmsAppend'].forEach(
            function(e) {
    ...
    (_ = function(e, t) {
      return (
        e instanceof S && (!(e.isRemoved || (t && $[e._id].conf.type !== t)) || null)
      )
    }),
    (y = {
      pointAnchor: {
        ...
        removeOption: function(e, t) {
          ...
          i === o &&
            (i = o === document.body ? new S(y.pointAnchor, [i]) : document.body),
            (a[t.optionName] = i),
            Ze(n, a)
        },
      ...
      mouseHoverAnchor: {
        ...
        init: function(a, i) {
          ...
          return (
            ...
            'inline' ===
            (o = a.element.ownerDocument.defaultView.getComputedStyle(a.element, ''))
              .display
            ...
            y.mouseHoverAnchor.dirKeys.forEach(function(e) {
              var t = 'padding' + e[1]
              a.style[t] &&
                ((f[t] = a.element.style[t]), (a.element.style[t] = a.style[t]))
            }),
      ...
      captionLabel: {
        ...
        init: function(u, t) {
          return (
            ...
            !!u.text &&
              ...
              (u.outlineColor =
                'string' == typeof t.outlineColor ? t.outlineColor.trim() : '#fff'),
        ...
        initSvg: function(t, n) {
          ...
          ;['elmPosition', 'styleFill', 'styleShow', 'elmsAppend'].forEach(function(
            e
          ) {
            t[e] = i[e]
          }),
                  ...
                  ((2 !== s.semIndex || s.lineOffset) &&
                    ...
                    2 !== s.semIndex &&
                      ((n =
                        ...
                        s.height / 4),
                      (a =
                        (a += 0 === s.semIndex ? n : -n) < 0 ? 0 : t < a ? t : a)),
                    s.lineOffset &&
                    ...
                    ? ((a = b.points),
                      ...
                      i <= Math.PI
                        ...
                        : ((l = Ee(a[0], a[1], x)),
                          ...
                          (y = p.y - h.y),
                          (S =
                            (-d * (s.x - h.x) + c * (s.y - h.y)) / (-f * d + c * y)),
                          (m =
                            (f * (s.y - h.y) - y * (s.x - h.x)) / (-f * d + c * y)),
                          (r =
                            0 <= S && S <= 1 && 0 <= m && m <= 1
                              ? { x: s.x + m * c, y: s.y + m * d }
                              : null)
